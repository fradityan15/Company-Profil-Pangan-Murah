      ...
      <main className="relative z-10 mx-auto w-full max-w-7xl px-6 py-20 sm:px-8 lg:px-10">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="text-5xl font-black tracking-tight text-white sm:text-6xl lg:text-7xl leading-tight animate-pop-in animate-pop-in-delay-1">
                Memimpin Gerakan <span className="text-blue-400">Pangan Terjangkau</span> dengan dampak sosial nyata.
              </h1>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-5 animate-pop-in animate-pop-in-delay-3">
              <Link href="/map" className="inline-flex items-center justify-center rounded-full bg-green-500 px-10 py-4 text-base font-black text-slate-950 transition-all duration-300 hover:bg-green-400 hover:scale-105">
                Lihat Mitra
              </Link>
        ...
        <section className="mt-20 grid gap-8 lg:grid-cols-3">
          {[
            ...
            <div key={item.title} className={`glass-card rounded-[2rem] border border-white/10 bg-white/5 p-10 shadow-xl shadow-slate-950/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl animate-pop-in animate-pop-in-delay-${index + 1}`}>
              <div className="flex h-14 w-14 items-center justify-center rounded-3xl bg-gradient-to-br from-green-500 to-cyan-500 text-2xl text-white mb-6 animate-pop-in-bounce" style={{animationDelay: `${0.2 + index * 0.1}s`}}>
                {item.icon}
              </div>
        ...
        <section className="mt-24 grid gap-8 lg:grid-cols-2 items-start border-t border-white/10 pt-20">
          <div className="space-y-6 animate-pop-in-left">
            <p className="text-sm uppercase tracking-[0.35em] text-slate-500 animate-pop-in-up">Layanan Kami</p>
            <h2 className="text-4xl font-black text-white leading-tight animate-pop-in-up animate-pop-in-delay-1">Solusi yang dirancang untuk pasar lokal dan kebutuhan masyarakat.</h2>
          ...
          <div className="grid gap-6 animate-pop-in-right animate-pop-in-delay-1">
            {[
              ...
              { title: 'Penawaran Cepat', desc: 'Promo dinamis setiap hari sesuai stok dan waktu terbaik.', color: 'from-purple-500 to-pink-500' },
              ...
              <div key={item.title} className={`glass-card rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-xl shadow-slate-950/30 animate-pop-in animate-pop-in-delay-${index + 2}`}>
                <div className={`inline-flex items-center gap-3 rounded-3xl bg-gradient-to-br ${item.color} px-4 py-3 text-white text-sm font-semibold mb-4 animate-pop-in-bounce`} style={{animationDelay: `${0.3 + index * 0.1}s`}}>
                  {item.title}
                </div>
                <p className="text-slate-400 leading-7 animate-pop-in-up" style={{animationDelay: `${0.4 + index * 0.1}s`}}>{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-24">
          <div className="grid gap-6 lg:grid-cols-3">
            {[
              ...
              <div key={item.title} className={`glass-card rounded-[2rem] border border-white/10 bg-white/5 p-10 text-center shadow-xl shadow-slate-950/30 animate-pop-in animate-pop-in-delay-${index + 1}`}>
                <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-3xl bg-slate-900 text-3xl text-purple-400 animate-pop-in-bounce" style={{animationDelay: `${0.2 + index * 0.1}s`}}>
                  {item.icon}
                </div>
                <h3 className="text-2xl font-bold text-white mb-3 animate-pop-in-up" style={{animationDelay: `${0.3 + index * 0.1}s`}}>{item.title}</h3>
                <p className="text-slate-400 leading-7 animate-pop-in-up" style={{animationDelay: `${0.4 + index * 0.1}s`}}>{item.detail}</p>
              </div>
            ))}
          </div>
        </section>

        <section className="mt-24 rounded-[2rem] border border-white/10 bg-gradient-to-br from-slate-900/80 to-slate-800/80 p-12 shadow-[0_40px_80px_-40px_rgba(15,23,42,0.9)] animate-pop-in animate-pop-in-delay-1">
          <div className="grid gap-8 lg:grid-cols-[1.3fr_0.7fr] items-center">
            <div>
              <p className="text-xs uppercase tracking-[0.35em] text-slate-500 animate-pop-in-left">Bersama untuk perubahan</p>
              <h2 className="mt-4 text-4xl font-black text-white leading-tight animate-pop-in-up animate-pop-in-delay-1">Berkolaborasi dengan komunitas, UMKM, dan pelanggan untuk masa depan pangan yang lebih baik.</h2>
            </div>
            <div className="space-y-4 text-slate-300 animate-pop-in-right animate-pop-in-delay-1">
              ...
              <Link href="/map" className="inline-flex items-center justify-center rounded-full bg-green-500 px-10 py-4 text-base font-black text-slate-950 transition-all duration-300 hover:bg-green-400 hover:scale-105 animate-pop-in-bounce animate-pop-in-delay-3">
                Jelajahi Sekarang
              </Link>
            </div>
          </div>
