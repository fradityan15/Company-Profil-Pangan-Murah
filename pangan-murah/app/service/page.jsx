        ...
        <section className="grid gap-16 lg:grid-cols-[1.2fr_0.8fr] items-center pb-20 border-b border-white/10">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl font-black tracking-tight text-white sm:text-6xl lg:text-7xl leading-tight animate-pop-in animate-pop-in-delay-1">
                Solusi Lengkap untuk <span className="text-purple-400">Pangan Berkelanjutan</span>.
              </h1>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-5 animate-pop-in animate-pop-in-delay-3">
              <Link href="/live-data" className="inline-flex items-center justify-center rounded-full bg-purple-500 px-10 py-4 text-base font-black text-slate-950 transition-all duration-300 hover:bg-purple-400 hover:scale-105">
                Jelajahi Katalog
              </Link>
              <Link href="/map" className="inline-flex items-center justify-center rounded-full border border-slate-700 bg-slate-900/80 px-10 py-4 text-base font-black text-slate-100 transition-all duration-300 hover:border-purple-400 hover:text-purple-300 hover:bg-purple-500/10 hover:scale-105">
                Cari Lokasi
              </Link>
            </div>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-1">
            <div className="glass-card rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-xl shadow-slate-950/30 animate-pop-in-right animate-pop-in-delay-1">
              <p className="text-xs uppercase tracking-[0.35em] text-slate-500 animate-pop-in-up">Platform Utama</p>
            ...
            <div className="glass-card rounded-[2rem] border border-white/10 bg-gradient-to-br from-slate-900/80 to-slate-800/80 p-8 shadow-xl shadow-slate-950/30 animate-pop-in-right animate-pop-in-delay-2">
              <p className="text-xs uppercase tracking-[0.35em] text-slate-500 animate-pop-in-up">Komitmen Layanan</p>
            ...
            {[
              ...
              <div key={item.title} className={`glass-card rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-xl shadow-slate-950/30 animate-pop-in animate-pop-in-delay-${index + 2}`}>
                <div className="flex items-center gap-4">
                  <div className={`inline-flex items-center justify-center rounded-3xl bg-gradient-to-br ${item.color} px-4 py-2 text-white text-sm font-black min-w-[3rem] animate-pop-in-bounce`} style={{animationDelay: `${0.2 + index * 0.1}s`}}>
                    {item.step}
                  </div>
        ...
        <section className="mt-24 animate-fade-in">
          <div className="grid gap-6 lg:grid-cols-4">
            {[
              ...
              <div key={item.title} className={`glass-card rounded-[2rem] border border-white/10 bg-white/5 p-8 text-center shadow-xl shadow-slate-950/30 animate-pop-in animate-pop-in-delay-${index + 1}`}>
        ...
        <section className="mt-24 rounded-[2rem] border border-white/10 bg-gradient-to-br from-slate-900/80 to-slate-800/80 p-12 shadow-[0_40px_80px_-40px_rgba(15,23,42,0.9)] animate-pop-in animate-pop-in-delay-1">
          <div className="grid gap-8 lg:grid-cols-[1.3fr_0.7fr] items-center">
            ...
            <div className="space-y-4 text-slate-300 animate-pop-in-right animate-pop-in-delay-1">
              ...
              <Link href="/live-data" className="inline-flex items-center justify-center rounded-full bg-purple-500 px-10 py-4 text-base font-black text-slate-950 transition-all duration-300 hover:bg-purple-400 hover:scale-105 animate-pop-in-bounce animate-pop-in-delay-3">
                Mulai Sekarang
              </Link>
            </div>
          </div>
