  ...
  return (
    <div className="md:hidden">
      <button
        ...
        className="rounded-3xl border border-white/10 bg-slate-950/90 p-3 shadow-xl shadow-black/20 flex items-center justify-between gap-3 text-sm uppercase tracking-[0.22em] text-amber-300"
      >
        Menu
      </button>
